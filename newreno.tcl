...
set f0 [open "newrenotcp0.xg" w]
set f6 [open "newrenotcp6.xg" w]
set f1 [open "newrenotcp1.xg" w]

proc finish {} {
	global ns tracefile namfile f0 f6 f2
	global f0 f6 f1
	$ns flush-trace
	close $tracefile
	close $namfile
	...
	#exec xgraph newrenotcp0.xg newrenotcp6.xg newrenotcp1.xg & #geometry-800*600 &
	exit
}
