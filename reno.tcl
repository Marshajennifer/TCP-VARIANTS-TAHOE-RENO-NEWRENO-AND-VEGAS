#xgraph renotcp0.xg renotcp6.xg renotcp1.xg
...
set f0 [open "renotcp0.xg" w]
set f6 [open "renotcp6.xg" w]
set f1 [open "renotcp1.xg" w]
...
proc finish {} {
	...
	close $f1
	exec nam reno.nam &
	#exec xgraph renotcp0.xg renotcp6.xg renotcp1.xg & #geometry-800*600 &
	exit
}
