#xgraph vegastcp0.xg vegastcp6.xg vegastcp1.xg
...
set f0 [open "vegastcp0.xg" w]
set f6 [open "vegastcp6.xg" w]
set f1 [open "vegastcp1.xg" w]
...
proc finish {} {
	...
	close $f1
	exec nam vegas.nam &
	#exec xgraph vegastcp0.xg vegastcp6.xg vegastcp1.xg & #geometry-800*600 &
	exit
}
